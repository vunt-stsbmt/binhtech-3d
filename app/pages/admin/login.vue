<template>
  <main class="mx-auto flex min-h-[100vh] max-w-6xl items-center justify-center px-4 py-10 sm:px-6">
...
useHead({
  title: "Đăng nhập Admin - Binhtech 3D",
  meta: [{ name: "description", content: "Đăng nhập khu vực quản trị Binhtech 3D" }]
})
